...
class EveApiRoles {
	...
	protected $roleDescriptions=array(
		...
		'junior accountant','starbase config','trader', 'chat manager', 
		'contract manager', 'infrastructure tactical officer', 
		'starbase caretaker', 'fitting manager');
	...
	protected $roleNames=array(
		...
		'rentoff','rentfact','rentres','jraccount','sbconfig','trader','chatman',
		'contman','strtacoff','starcare','fitman');
